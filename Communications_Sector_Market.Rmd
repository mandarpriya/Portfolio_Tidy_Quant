...
prices |> 
    ...
    labs(
        title = "Selected Communication-Sector Stocks Prices",
...
prices |> 
    plot_time_series(
        ...
        .smooth = FALSE,
        .title = "Selected Communication-Sector Stock Prices",
...
returns_tbl |> 
    ...
    labs(
        title = "Monthly Returns for Selected Communication-Sector Stocks",
...
returns_tbl |> 
    plot_time_series(
        ...
        .facet_vars        = symbol,
        .facet_ncol        = 2,
        .title             = "Monthly Returns Selected Communications-Sector Stocks",
        .x_lab             = "",
        .y_lab             = "Returns",
        .y_intercept       = 0,
        .y_intercept_color = "Black",
...
#Combining the Stock-Returns and Fama-French factors
```{r}
...
port_tbl |> 
    ...
    .title = "Portfolio Returns for Communications-Sector",
    .y_lab = "Returns",
    .x_lab = "",
    .y_intercept = 0,
...
beta_estimation_tbl |> 
    plot_time_series(
        ...
        .x_lab = "",
        .y_lab = "Beta",
        .title = "Beta Estimates for Selected Communications-Sector Stocks ",
        .legend_show = FALSE
    )
```
...
beta_port_tbl |> 
    plot_time_series(
        ...
        .y_lab = "Beta",
        .x_lab = "",
        .title = "Beta Estimates of Portfolio Returns for Communications-Sector"
    )
```
