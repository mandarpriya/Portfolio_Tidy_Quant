...
prices |> 
    ...
    labs(
        title = "Selected Real-Estate Stock Prices",
...
prices |> 
    plot_time_series(
        ...
        .smooth = FALSE,
        .title = "Selected Real_Estate  Stock Prices",
...
returns_tbl |> 
    ...
    labs(
        title = "Monthly Returns for Selected Real-Estate Sector Stocks",
...
returns_tbl |> 
    plot_time_series(
        ...
        .facet_vars        = symbol,
        .facet_ncol        = 2,
        .title             = "Monthly Returns Selected Real-Estate-Sector Stocks",
        .x_lab             = "",
        .y_lab             = "Returns",
        .y_intercept       = 0,
        .y_intercept_color = "Black",
...
port_tbl |> 
    ...
    .title = "Portfolio Returns for Real-Estate- Sector",
    .y_lab = "Returns",
    .x_lab = "",
    .y_intercept = 0,
...
beta_estimation_tbl |> 
    plot_time_series(
        ...
        .x_lab = "",
        .y_lab = "Beta",
        .title = "Beta Estimates for Selected Real-Estate-Sector Stocks ",
        .legend_show = FALSE
    )
```
...
beta_port_tbl |> 
    plot_time_series(
        ...
        .y_lab = "Beta",
        .x_lab = "",
        .title = "Beta Estimates of Portfolio Returns for Real-Estate-Sector"
    )
```
