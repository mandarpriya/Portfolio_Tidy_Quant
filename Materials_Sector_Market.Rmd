...
prices |> 
    ...
    labs(
        title = "Stock Prices for selected Materials -Sector Stocks",
        subtitle = "GWW has an upward trend",
        y = "Adjusted Prices",
        x = ""
    )
```
...
prices |> 
    plot_time_series(
        ...
        .x_lab = "",
        .title = "Selected Stocks Prices of Materials-Sector",
        .legend_show = FALSE
    )
```
...
returns_tbl |> 
    ...
    labs(
        title = "Monthly Returns for Selected Materials- Sector Stocks",
        subtitle = "Common Periods of Volatility : 2000, 2008, 2020",
        x = "",
        y = "Returns"
    )
```
...
returns_tbl |> 
    plot_time_series(
        ...
        .facet_vars        = symbol,
        .facet_ncol        = 2,
        .title             = "Monthly Returns Selected Materials-Sector Stocks",
        .x_lab             = "",
        .y_lab             = "Returns",
        .y_intercept       = 0,
        .y_intercept_color = "Black",
...
```
# Combining the Returns and Fama-French 
```{r}
...
port_tbl
```
#Visualization of Portfolio Returns : Interactive Plot
```{r}
port_tbl |> 
    plot_time_series(
    .date_var = date,
...
beta_estimation_tbl
```
# Visualization of Beta Estimates for Stock 
```{r}
beta_estimation_tbl |> 
    plot_time_series(
        .date_var = date,
        ...
        .x_lab = "",
        .y_lab = "Beta",
        .title = "Beta Estimates for Selected Materials-Sector Stocks ",
        .legend_show = FALSE
    )
```

# Beta Estimates of Portfolio
```{r}
